...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post ciudades_url, params: { ciudade: { departamento_id: @ciudade.departamento_id, nombre: @ciudade.nombre } }
    end
  ...
  test "should update ciudade" do
    patch ciudade_url(@ciudade), params: { ciudade: { departamento_id: @ciudade.departamento_id, nombre: @ciudade.nombre } }
