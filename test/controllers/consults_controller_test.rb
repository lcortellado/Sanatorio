...
class ConsultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consult" do
    assert_difference('Consult.count') do
      post consults_url, params: { consult: { tipo_consult_id: @consult.tipo_consult_id, turno_id: @consult.turno_id } }
    end
  ...
  test "should update consult" do
    patch consult_url(@consult), params: { consult: { tipo_consult_id: @consult.tipo_consult_id, turno_id: @consult.turno_id } }
