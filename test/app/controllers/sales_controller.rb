class SalesController < ApplicationController
  ...
  def new
    ...
    @sale = Sale.create(date: Date::current, number: number, state: "draft", usuario: current_usuario)
  ...
  private
    ...
    def sale_params
      params.require(:sale).permit(:number, :date, sale_details_attributes: [:id, :sale_id, :insumo_id, :number, :qty, :price, :_destroy] )
    end
end
