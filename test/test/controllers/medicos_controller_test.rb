...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { apellido: @medico.apellido, celular: @medico.celular, ci: @medico.ci, contacto_familiar: @medico.contacto_familiar, correo: @medico.correo, direccion: @medico.direccion, especialidade_id: @medico.especialidade_id, fecha_naci: @medico.fecha_naci, nombre: @medico.nombre, nro_registro: @medico.nro_registro, telefono: @medico.telefono } }
    end
