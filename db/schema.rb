...
ActiveRecord::Schema.define(version: 20171107225924) do
  ...
  create_table "compra_datails", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "number"
    t.bigint "insumo_id"
    t.integer "qty"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["compra_id"], name: "index_compra_datails_on_compra_id"
    t.index ["insumo_id"], name: "index_compra_datails_on_insumo_id"
  end
  ...
  create_table "compras", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer "state"
    t.bigint "usuario_id"
    t.bigint "formas_pago_id"
    t.bigint "proveedore_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["formas_pago_id"], name: "index_compras_on_formas_pago_id"
    t.index ["proveedore_id"], name: "index_compras_on_proveedore_id"
  ...
  create_table "detallefactproveedores", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "factproveedore_id"
    t.bigint "number"
    t.bigint "insumo_id"
    t.integer "cantidad"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["factproveedore_id"], name: "fk_rails_09ee06a00e"
    t.index ["insumo_id"], name: "fk_rails_cec3ab9573"
  end

  create_table "detallepedidos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["insumo_id"], name: "index_detallepedidos_on_insumo_id"
    t.index ["pedido_id"], name: "index_detallepedidos_on_pedido_id"
  end
  ...
  create_table "factproveedores", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "codigo"
    t.bigint "usuario_id"
    t.bigint "sanatorio_id"
    t.bigint "pedido_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "tpago", default: false
    t.bigint "formas_pago_id"
    t.integer "state"
    t.date "date"
    t.decimal "total", precision: 10
    t.index ["formas_pago_id"], name: "index_factproveedores_on_formas_pago_id"
    t.index ["pedido_id"], name: "index_factproveedores_on_pedido_id"
    t.index ["sanatorio_id"], name: "index_factproveedores_on_sanatorio_id"
    t.index ["usuario_id"], name: "index_factproveedores_on_usuario_id"
  end
  ...
  create_table "historias", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "codigo"
    t.string "diagnostico"
    t.string "indicaciones"
    t.date "fecha_proxima_cita"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reserva_id"], name: "index_historias_on_reserva_id"
  end
  ...
  create_table "insumos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "codigo", limit: 50, default: "0", null: false
    t.string "descripcion", limit: 50, default: "0", null: false
    t.integer "precio_compra", default: 0, null: false
    t.integer "precio_venta", default: 0, null: false
    t.integer "stock", default: 0, null: false
    t.integer "stock_minimo", default: 0, null: false
    t.bigint "proveedore_id"
  ...
  create_table "pedidos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "pedido_id"
    t.index ["pedido_id"], name: "index_pedidos_on_pedido_id"
  ...
  create_table "sale_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.bigint "pedido_id"
    t.bigint "detallepedido_id"
    t.index ["detallepedido_id"], name: "index_sale_details_on_detallepedido_id"
    t.index ["pedido_id"], name: "index_sale_details_on_pedido_id"
  end
  ...
  create_table "sales", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.bigint "proveedore_id"
    t.bigint "pedido_id"
    t.index ["formas_pago_id"], name: "index_sales_on_formas_pago_id"
    t.index ["paciente_id"], name: "index_sales_on_paciente_id"
    t.index ["pedido_id"], name: "index_sales_on_pedido_id"
    t.index ["proveedore_id"], name: "index_sales_on_proveedore_id"
  end
  ...
  create_table "venta_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "number"
    t.integer "qty"
    t.integer "price"
    t.integer "venta_id"
  ...
  create_table "ventas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["formas_pago_id"], name: "index_ventas_on_formas_pago_id"
    t.index ["paciente_id"], name: "index_ventas_on_paciente_id"
  end
  ...
  add_foreign_key "compra_datails", "insumos"
  add_foreign_key "compras", "formas_pagos"
  add_foreign_key "compras", "proveedores"
  ...
  add_foreign_key "detallefactproveedores", "factproveedores"
  add_foreign_key "detallefactproveedores", "insumos"
  add_foreign_key "detallepedidos", "insumos"
  ...
  add_foreign_key "factproveedores", "formas_pagos"
  add_foreign_key "factproveedores", "pedidos"
  add_foreign_key "factproveedores", "sanatorios"
  add_foreign_key "factproveedores", "usuarios"
  add_foreign_key "historia_pacientes", "reservas"
  add_foreign_key "historias", "reservas"
  ...
  add_foreign_key "pedidos", "pedidos"
  ...
  add_foreign_key "sale_details", "detallepedidos"
  add_foreign_key "sale_details", "pedidos"
  add_foreign_key "sales", "formas_pagos"
  add_foreign_key "sales", "pacientes"
  add_foreign_key "sales", "pedidos"
  add_foreign_key "sales", "proveedores"
  add_foreign_key "turnos", "medicos"
  add_foreign_key "turnos", "pacientes"
  add_foreign_key "ventas", "formas_pagos"
  add_foreign_key "ventas", "pacientes"
end
